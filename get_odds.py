...
def get_odds():
    while True:
        ...
        f = open("/var/www/html/odd.json","w",encoding="utf-8")  
    ...
    while True:
        ...
        for i in l:
            ...
            try:
                ...
                f = open("/var/www/html/last_result_card.json","w")
                for i in list_of_data:
                    f.write(i)
                f.close()
...
# while True:
    # get_odds()
# get_odds()# from selenium import webdriver
# from bs4 import BeautifulSoup
# from selenium.webdriver.common.keys import Keys
# from time import sleep
# from selenium.webdriver.support.ui import WebDriverWait
